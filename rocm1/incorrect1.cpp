...
// geometry : tC0_tA1_tB0_colMaj0_m2048_n121_k1_lda2048_ldb121_ldc121_ws0_f32
// hyperparams : A_MIC1_PAD0_PLU0_LIW0_MIW1_WOS0_VEW1__B_MIC1_PAD0_PLU1_LIW0_MIW0_WOS0_VEW1__C_UNR32_GAL2_PUN0_ICE1_IWI1_SZT0_NAW16_UFO0_MAC64_SKW10_AFI1_MIA0
...
int main()
{ 
  size_t a_n_elms = 2048;
  size_t b_n_elms = 121;
  size_t c_n_elms = 247808;
...
#define N_ELEMENTS_IN_PADDED_A_UNROLL 256
...
#define N_MICRO_A_TILES_PLL_UNROLL 32 
...
#define N_ELEMENTS_IN_B_UNROLL 256
#define N_GROUPS_B 16
#define PRESHIFT_FINAL_TILE_B 1
#define STRIDE_PLL_K_B 121
#define MACRO_STRIDE_PLL_K_B 121
...
#define N_ELEMENTS_IN_PADDED_B_UNROLL 256
...

{
 ...
 TFLOAT rC[MICRO_TILE_LENGTH_A][MICRO_TILE_LENGTH_B] = {{0.}};
  ...
  size_t global_work_size = 262144;
 ...
 checkstatus(ret, "clEnqueueReadBuffer");
  ...
  // (precomputed in standalone.cpp using OpenBLAS)
   float sum_final_cpu = 20.899591445922851562;
  ...
  std::cout << "sum of final on cpu = " <<  20.899591445922851562  << std::endl; 

...
void basicfind(const tinygemm::TinyGemmGeometry & geometry, const tinygemm::TinyGemmOffsets & toff, float allotted_time, bool verbose, std::string logfile, std::string constraint_string, std::string start_string, unsigned n_postfind_runs, bool do_cpu_test){
  ...
  * ******************************************************************/
   ...
   * Find a solution *
   * *****************/
  tinygemm::TinyGemmSolution soln = tinygemm::find(allotted_time, command_queue, a_gpu, b_gpu, c_gpu, workspace_gpu, constraint_string, start_string, geometry, toff, verbose, logfile);

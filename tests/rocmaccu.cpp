...
// geometry : tC0_tA1_tB0_colMaj0_m300_n300_k300_lda300_ldb300_ldc300_ws0_f32
// hyperparams : A_MIC1_PAD0_PLU0_LIW0_MIW1_WOS0_VEW1__B_MIC1_PAD0_PLU1_LIW0_MIW0_WOS0_VEW1__C_UNR16_GAL2_PUN0_ICE1_IWI1_SZT0_NAW16_UFO0_MAC64_SKW10_AFI1_MIA0
...
int main()
{ 
  size_t a_n_elms = 90000;
  size_t b_n_elms = 90000;
  size_t c_n_elms = 90000;
...
// (no longer including time-stamp here to ease string comparison) 

/* this kernel was generated for starting geometry : */
/* tC0_tA1_tB0_colMaj0_m300_n300_k300_lda300_ldb300_ldc300_ws0_f32*/
#define __K__ 300
#define TFLOAT  float
...
#define C_INTERWEAVE_STRIDE_A 8


/* ********************************** specific to B *************************************** */
#define MACRO_TILE_LENGTH_B 8
#define N_ELEMENTS_IN_B_UNROLL 128
#define N_GROUPS_B 38
#define PRESHIFT_FINAL_TILE_B 4
#define STRIDE_PLL_K_B 300
#define MACRO_STRIDE_PLL_K_B 300
#define STRIDE_PERP_K_B 1
#define MACRO_STRIDE_PERP_K_B 1
#define TVFLOATB float
#define VEW_B  1
#define MICRO_TILE_LENGTH_B 1
#define PAD_LDS_B  0
#define WORK_ITEM_LOAD_B_PLL_TO_UNROLL 1
#define MACRO_TILE_LENGTH_B_AND_PAD 8
#define N_ELEMENTS_IN_PADDED_B_UNROLL 128
#define N_ELEMENTS_OF_B_TO_LOAD_PER_WORKITEM 2
#define N_MICRO_IN_MACRO_B  8
#define MICRO_B_TILE_PLL_UNROLL 2 
...
#define TINTA unsigned
#define TINTB unsigned
#define TINTC unsigned
#define TINTW ushort
...
#define MACRO_TILE_AREA 64
#define MICRO_TILE_AREA 1
...

{
  ...
  const TINTA write_start_a = write_macro_tile_start_a + micro_id_a*(VEW_A/1);
  ...
  const TINTB b_offset_pll_unroll = MICRO_B_TILE_PLL_UNROLL * pll_unroll_b_load_id;
  const TINTB b_offset_perp_unroll = MICRO_B_TILE_PERP_UNROLL * perp_unroll_b_load_id;
  const TINTB b_offset_perp_unroll_v = MICRO_B_TILE_PERP_UNROLL/VEW_B * perp_unroll_b_load_id;
 ...
 TFLOAT rC[MICRO_TILE_LENGTH_A][MICRO_TILE_LENGTH_B] = {{0.}};
  ...
  while (n_unrolls_remaining > 0){
    ...
    for (TINTB mu_perp_i = 0; mu_perp_i < MICRO_B_TILE_PERP_UNROLL/VEW_B; ++mu_perp_i) {
      for (TINTB mu_pll_i = 0; mu_pll_i < MICRO_B_TILE_PLL_UNROLL; ++mu_pll_i) {
    ...
    lA = localA + micro_id_a*VEW_A/VEW_A;
  ...
  if ((group_id_b != N_GROUPS_B - 1) && (group_id_a != N_GROUPS_A - 1)){ 
    ...
    for (TINTA dimai = 0; dimai < MACRO_TILE_LENGTH_A/VEW_A; dimai += N_MICRO_IN_MACRO_A) {
 ...
 checkstatus(ret, "clEnqueueReadBuffer");
  ...
  std::cout << "sum of initial c = " << std::setprecision(15) << sum_init << std::endl;
  std::cout << "sum of final c   = " << std::setprecision(15) << sum_final << std::endl;

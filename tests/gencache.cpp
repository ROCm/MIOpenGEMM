...
int main(){
  ...
  std::vector<tinygemm::TinyGemmGeometry> geometries = {{"tC0_tA1_tB0_colMaj1_m1200_n1_k1_lda1_ldb1_ldc1200_ws0_f32", }};
  ...
  if (false){
    ...
    auto more_geometries = tinygemm::get_from_m_n_k_ldaABC_tA_tB({std::make_tuple(800, 64, 16, 16, 16, 800, true, false)}, 0);
    ...
    more_geometries = tinygemm::get_from_m_n_k_tA_tB({std::make_tuple(20, 30, 40, false, false)}, 0);
    geometries.insert(geometries.end(), more_geometries.begin(), more_geometries.end());
  }

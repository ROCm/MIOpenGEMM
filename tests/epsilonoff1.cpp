...
// geometry : tC0_tA0_tB0_colMaj1_m128_n128_k128_lda128_ldb128_ldc128_ws0_f32
// hyperparams : A_MIC4_PAD1_PLU0_LIW0_MIW1_WOS0_VEW1__B_MIC4_PAD1_PLU1_LIW0_MIW0_WOS0_VEW1__C_UNR16_GAL1_PUN0_ICE1_IWI1_SZT0_NAW16_UFO0_MAC64_SKW10_AFI1_MIA0
...
int main()
{ 
  size_t a_n_elms = 16384;
  size_t b_n_elms = 16384;
  size_t c_n_elms = 16384;
...
#define MACRO_TILE_LENGTH_A 32
/* number of elements in load block : MACRO_TILE_LENGTH_A * UNROLL */
#define N_ELEMENTS_IN_A_UNROLL 512
...
#define STRIDE_PLL_K_A 128
#define MACRO_STRIDE_PLL_K_A 128
...
#define MACRO_TILE_LENGTH_A_AND_PAD 33
/* MACRO_TILE_LENGTH_A_AND_PAD * UNROLL : */
#define N_ELEMENTS_IN_PADDED_A_UNROLL 528
/* N_ELEMENTS_IN_A_UNROLL / N_WORK_ITEMS_PER_WORKGROUP : */
#define N_ELEMENTS_OF_A_TO_LOAD_PER_WORKITEM 8
...
#define MICRO_A_TILE_PERP_UNROLL 8
...
/* ********************************** specific to B *************************************** */
#define MACRO_TILE_LENGTH_B 32
#define N_ELEMENTS_IN_B_UNROLL 512
#define N_GROUPS_B 4
#define STRIDE_PLL_K_B 1
#define MACRO_STRIDE_PLL_K_B 1
#define STRIDE_PERP_K_B 128
#define MACRO_STRIDE_PERP_K_B 128
#define TVFLOATB float
#define VEW_B  1
#define MICRO_TILE_LENGTH_B 4
#define PAD_LDS_B  1
#define WORK_ITEM_LOAD_B_PLL_TO_UNROLL 1
#define MACRO_TILE_LENGTH_B_AND_PAD 33
#define N_ELEMENTS_IN_PADDED_B_UNROLL 528
#define N_ELEMENTS_OF_B_TO_LOAD_PER_WORKITEM 8
#define N_MICRO_IN_MACRO_B  8
#define MICRO_B_TILE_PLL_UNROLL 8 
...
#define MACRO_TILE_AREA 1024
#define MICRO_TILE_AREA 16
...

{
 ...
 checkstatus(ret, "clEnqueueReadBuffer");
  ...
  // (precomputed in standalone.cpp using OpenBLAS)
   float sum_final_cpu = 230.215576171875;
  ...
  std::cout << "sum of final on cpu = " <<  230.215576171875  << std::endl; 

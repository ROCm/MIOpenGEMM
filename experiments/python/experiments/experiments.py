...
def do_kernel_tests(outputfilename = "default", kernel_savedir = None, do_test = True, forcefilewrite = False):
  ...
  matrix_mnk = {'m': 4608, 'n': 512, 'k': 49}
  
  #Y32_X48_y2_x3_U16_P1_GA1_APLU0_BPLU0_PU1_LIW0_MIW1_ET1_ICE1_UFO0
  
  micro_tiles = [[2,3]] 
  mm_tiles = [[16*a, 16*b, a, b] for a, b in micro_tiles]
  #with padding 2 I sometimes get better than with padding 1 (!)
  kernel_span = {'Y_X_y_x' :mm_tiles, 'unrolls':[16], 'pads' : [1], 'group_allocations' : [1], 'work_item_load_a_pll_to_unrolls' : [0],'work_item_load_b_pll_to_unrolls' : [1],'unroll_pragmas' : [1], 'load_to_lds_interwovens' : [0], 'c_micro_tiles_interwovens': [1], 'use_edge_tricks':[1], 'n_work_items_per_c_elms':[1], "unroll_for_offsets":[0]}#3,6,8,10]}#,3,4,5,6,7,8]}

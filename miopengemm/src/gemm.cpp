...
//  auto device_name = get_device_name(device_id);
  ...
  //auto gemm_key = get_gemm_key(isColMajor, tA, tB, tC, lda, ldb, ldc, m, n, k, w_size, sizeof(T));
  
  //, device_name);

  //for (size_t x = 0; x < 5; ++ x){
    //gemm_key = get_gemm_key(isColMajor, tA, tB, tC, lda, ldb, ldc, m, n, k, w_size, sizeof(T));//, device_name);
  //}
...
template GemmStatus xgemm<float>(bool, bool, bool, size_t, size_t, size_t, float, cl_mem, size_t, size_t, cl_mem, size_t, size_t, float, cl_mem, size_t, size_t, cl_mem, size_t, size_t, cl_command_queue*, cl_uint, const cl_event*, cl_event*);

template GemmStatus xgemm<double>(bool, bool, bool, size_t, size_t, size_t, double, cl_mem, size_t, size_t, cl_mem, size_t, size_t, double, cl_mem, size_t, size_t, cl_mem, size_t, size_t, cl_command_queue*, cl_uint, const cl_event*, cl_event*);

...
"",
{"A_MIC8_PAD2_PLU0_LIW0_MIW0_WOS0__B_MIC6_PAD1_PLU0_LIW0_MIW0_WOS0__C_UNR8_GAL2_PUN0_ICE1_NAW64_UFO0_MAC256_SKW10",
...
/* TODO : certain of these kernels are slow, to cover the case (ROCm) of problems in compilation with small k. Fix this */
CachedSolution get_generic_cached_solution(const std::string & constraints_string, const Geometry & gg){
  ...
  if (gg.m*gg.n > 2000*2000 && gg.m >= 256 && gg.n >= 256){ /* was 5719.51 gflops on Fiji at Tue May 16 08:38:59 2017 */ 
    cached_soln = {"A_MIC8_PAD1_PLU0_LIW0_MIW0_WOS0__B_MIC6_PAD2_PLU0_LIW0_MIW0_WOS0__C_UNR8_GAL2_PUN0_ICE1_NAW16_UFO0_MAC256_SKW10", {0,0,0, "None", {200, 10, 3, Max}}};
  }
  
  else if (gg.m*gg.n > 800*800 && gg.m >=  256. && gg.n >= 128){ /* was 3095 on a Fiji on Tue May 16 08:46:49 2017  */
    cached_soln = {"A_MIC8_PAD1_PLU0_LIW0_MIW0_WOS0__B_MIC4_PAD0_PLU0_LIW0_MIW0_WOS0__C_UNR16_GAL1_PUN1_ICE1_NAW64_UFO0_MAC256_SKW10", {0,0,0, "None", {200, 10, 3, Max}}};
  }
  
  else if (gg.m*gg.n > 300*300  && gg.m >=  64 && gg.n >= 64){
    cached_soln = {"A_MIC2_PAD1_PLU0_LIW0_MIW0_WOS0__B_MIC2_PAD2_PLU0_LIW0_MIW0_WOS0__C_UNR16_GAL3_PUN0_ICE1_NAW64_UFO0_MAC256_SKW10", {0,0,0, "None", {200, 10, 3, Max}}};
  }
  
  else if (gg.m*gg.n > 128*128 && gg.m >= 16 && gg.n >= 16){ /* Tue May 16 09:07:04 2017 */
    cached_soln = {"A_MIC1_PAD1_PLU0_LIW0_MIW0_WOS0__B_MIC2_PAD2_PLU0_LIW0_MIW0_WOS0__C_UNR32_GAL2_PUN1_ICE1_NAW64_UFO0_MAC64_SKW10", {0,0,0, "None", {200, 10, 3, Max}}};    
  }
  
  else if (gg.m >= 16 && gg.n >= 16){
    cached_soln = {"A_MIC1_PAD0_PLU0_LIW0_MIW0_WOS0__B_MIC1_PAD0_PLU0_LIW0_MIW0_WOS0__C_UNR16_GAL2_PUN1_ICE1_NAW64_UFO0_MAC256_SKW10", {0,0,0, "None", {200, 10, 3, Max}}};    
 
  }
  
  else if (gg.m >= 8 && gg.n >= 8){
    cached_soln = {"A_MIC1_PAD0_PLU0_LIW0_MIW0_WOS0__B_MIC2_PAD1_PLU0_LIW0_MIW0_WOS0__C_UNR16_GAL3_PUN1_ICE1_NAW64_UFO0_MAC16_SKW10", {0,0,0, "None", {200, 10, 3, Max}}};     
  }

  else if (gg.m >= 4 && gg.n >= 4){
    cached_soln = {"A_MIC1_PAD2_PLU0_LIW0_MIW0_WOS0__B_MIC1_PAD1_PLU0_LIW0_MIW0_WOS0__C_UNR16_GAL2_PUN0_ICE1_NAW64_UFO0_MAC16_SKW10", {0,0,0, "None", {200, 10, 3, Max}}};     
  }
  
  else{
    cached_soln = {"A_MIC1_PAD0_PLU0_LIW0_MIW0_WOS0__B_MIC1_PAD0_PLU0_LIW0_MIW0_WOS0__C_UNR8_GAL1_PUN0_ICE1_NAW16_UFO0_MAC1_SKW10", {0,0,0, "None", {200, 10, 3, Max}}};         
  }

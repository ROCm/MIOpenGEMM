...
std::vector<Geometry> get_small_deepbench_geometries(size_t small_threshold, size_t wSpaceSize = 1);

std::vector<Geometry> get_large_deepbench_geometries(size_t large_threshold, size_t wSpaceSize = 1);
